...
router.post('/login', async (req, res) => {
  ...
  res.json({
    ...
    school: { id: school.id, name: school.name, logoDataUrl: school.logoDataUrl || null, phone: school.phone || '' },
  });
});
...
router.get('/me', requireStudentAuth, async (req, res) => {
  ...
  res.json({
    ...
    school: { id: req.school.id, name: req.school.name, logoDataUrl: req.school.logoDataUrl || null, phone: req.school.phone || '' },
    modules,
  });
});
